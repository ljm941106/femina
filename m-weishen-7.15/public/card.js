! function (t, e) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" ==
		typeof define && define.amd ? define(e) : t.LotteryCard = e()
}(this, function () {
	"use strict";
	...
	var t = function (t, e) {
		...
		n = function () {
			...
			return e.prototype.on = function (t, e) {
				...
				if (this._queue[t]) {
					var i = void 0 === e ? -2 : this._queue[t].indexOf(e); - 2 === i ? delete this._queue[t] : -
						1 !== i && this._queue[t].splice(i, 1), this._queue[t] && 0 === this._queue[t].length &&
				...
				for (var e = this, i = arguments.length, n = Array(i > 1 ? i - 1 : 0), o = 1; o < i; o++) n[o -
					1] = arguments[o];
	...
	return function (n) {
		function o(e, s) {
			...
			return h.options = Object.assign({
					...
					resize: !0,
					cover: null
				}, s), h.canvas = e, h.ctx = e.getContext("2d"), h._first = !0, h._touch = !1, h.init(), h.bind(),
				h
		}
		return e(o, n), o.prototype.getCanvasInfo = function () {
			var t = this.canvas.getBoundingClientRect(),
				...
				i = window.pageXOffset || document.documentElement.scrollLeft || document.body.scrollLeftp ||
				0;
			this.width = t.width, this.height = t.height, this.offsetX = Math.round(t.left + i), this.offsetY =
				Math.round(t.top + e), this.canvas.width = t.width, this.canvas.height = t.height
			...
			this.canvas.addEventListener(t ? "touchstart" : "mousedown", this.onTouchStart.bind(this), !1),
				...
				document.addEventListener(t ? "touchend" : "mouseup", this.onTouchEnd.bind(this)), window.addEventListener(
					"onorientationchange" in document ? "orientationchange" : "resize", this.onResize.bind(this)
				)
			...
			this._first = !0, this._touch = !1, this.canvas.style.backgroundImage = null, this.init(),
				this.trigger("reset")
		}, o.prototype.setResult = function (t) {
			this.canvas.style.backgroundImage = "url(" + t + ")"
		}, o.prototype.draw = function () {
			"end" !== this._state && (this._state = "end", this.ctx.clearRect(0, 0, this.width, this.height),
				this.trigger("end"))
		}, o.prototype.scratchPercent = function () {
			for (var t = this.ctx.getImageData(0, 0, this.width, this.height), e = 0, i = 0, n = t.data.length; i <
				n; i += 4) 0 === t.data[i] && 0 === t.data[i + 1] && 0 === t.data[i + 2] && 0 === t.data[i +
				3] && e++;
			...
			if (t.preventDefault(), "end" !== this._state) {
				...
				this._state = "start", this._touch = !0, this._first = !1, this.ctx.beginPath(), this.ctx.arc(
						e.x, e.y, this.options.size / 2, 0, 2 * Math.PI, !0), this.ctx.closePath(), this.ctx.fill(),
					this.ctx.beginPath(), this.ctx.lineWidth = this.options.size, this.ctx.moveTo(e.x, e.y)
			}
			...
			if (this._touch) {
				this._touch = !1;
				var e = this.getEventXY(t);
				this.ctx.closePath(), this.ctx.beginPath(), this.ctx.arc(e.x, e.y, this.options.size / 2, 0,
						2 * Math.PI, !0), this.ctx.closePath(), this.ctx.fill(), this.scratchPercent() >= this.options
					.percent && (this.ctx.clearRect(0, 0, this.width, this.height), this._state = "end", this.trigger(
						"end"))
			}
