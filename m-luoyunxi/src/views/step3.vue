<template>
	<div class="swiper-page step3 ">
		...
		<div class="text text1" :class="{active: text1Show && currentIndex == 1}">
			<img src="../img/text-3-1.png" />
		</div>
		...
		<div class="play wow fadeIn" data-wow-duration="2s" v-if="currentIndex == 5 || currentIndex == 0">
			<img src="../img/step3-play.png" alt="" />
		</div>
		...
		<div class="swiper-button-prev"><img src="../img/swiper-prev.png" /></div>
		<div class="swiper-button-next"><img src="../img/swiper-next.png" /></div>
	</div>
</template>
