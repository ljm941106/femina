<template>
	<div class="item">
		...
		<div class="swiper-indicator">
			{{swiperCurrentIndex+1}}/{{detail.length}}
		</div>
		...
		<buy-popup :show='isBuyPopupShow' @hideBuyPopup="hideBuyPopup" :magazineId="id" :buyTitle="buyTitle" @buySuccess="buySuccess"></buy-popup>
